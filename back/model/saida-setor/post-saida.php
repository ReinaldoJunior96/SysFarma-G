...
if (count($erro) == 0) {
    header("location: ../../../views/cadastro-saida/cadastro-saida-produtos-farmacia.php?produtos=success");
} else {
    $query = http_build_query(array('erroprod' => $erro));
    header("location: ../../../views/cadastro-saida/cadastro-saida-produtos-farmacia.php?" . $query);
}
