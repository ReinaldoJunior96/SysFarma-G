        ...
        <div class="col-md-12 mt-3">
            ...
            <div class="card">
                <div class="card-header bg-olive">
                    ...
                    $today = new DateTime();
                    ?>
                    <h3 class="card-title"><i class="fas fa-file-invoice"></i> Ponto de compra
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        $produtosPontoCompra = $produto->relatorioPontoCompra();
                        $contagem = 0;
                        foreach ($produtosPontoCompra as $v) :
                            ?>
                            <tr>
                                <td><?= $contagem ?></td>
                                <td><?= $v->produto_e ?></td>
