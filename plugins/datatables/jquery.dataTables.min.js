...
k?0!==this.context.length?this.context[0]._iDisplayLength:k:this.iterator("table",function(b){Ta(b,a)})});var Ub=function(a,b,c){if(c){var d=new r(a);d.one("draw",function(){c(d.ajax.json())})}if("ssp"==y(a))T(a,b);else{D(a,!0);var e=a.jqXHR;e&&4!==e.readyState&&e.abort();ta(a,[],function(c){pa(a);for(var c=ua(a,c),d=0,e=c.length;d<e;d++)O(a,c[d]);T(a,b);D(a,!1)})}};o("avaria-ordem-ordem-compra-ordem-compra-ajax.json()",function(){var a=this.context;if(0<a.length)return a[0].json});o("avaria-ordem-ordem-compra-ordem-compra-ajax.params()",function(){var a=this.context;if(0<
a.length)return a[0].oAjaxData});o("avaria-ordem-ordem-compra-ordem-compra-ajax.reload()",function(a,b){return this.iterator("table",function(c){Ub(c,!1===b,a)})});o("avaria-ordem-ordem-compra-ordem-compra-ajax.url()",function(a){var b=this.context;if(a===k){if(0===b.length)return k;b=b[0];return b.ajax?h.isPlainObject(b.ajax)?b.ajax.url:b.ajax:b.sAjaxSource}return this.iterator("table",function(b){h.isPlainObject(b.ajax)?b.ajax.url=a:b.ajax=a})});o("avaria-ordem-ordem-compra-ordem-compra-ajax.url().load()",function(a,b){return this.iterator("table",function(c){Ub(c,!1===b,a)})});var bb=function(a,b,c,d,e){var f=
